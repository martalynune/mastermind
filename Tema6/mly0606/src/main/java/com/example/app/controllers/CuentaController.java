...
public class CuentaController {
    ...
    public String showDelete(@PathVariable String IBAN,Model model) throws NotFoundException {
       try {
           cuentaService.borrar(IBAN);
           return "redirect:/cuenta/list";
       }catch  (NotFoundException e) {
           model.addAttribute("txtError", "No se puede borrar la cuenta porque el saldo no es cero");
           return "redirect:/cuenta/?err=1";
        }
    }
}
