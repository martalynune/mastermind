...
return args -> {
	...
	empleadoService.agregar
				(new Empleado(0L, "pepe", "pepe@gmail.com", 800d, true,	Genero.MASCULINO,
						departamentoService.obtenerPorNombre("Informática"),categoriaService.obtenerPorNombre("Jefe de Equipo")));
	empleadoService.agregar(
				new Empleado(0L, "ana", "ana@gmail.com", 2000d, true, Genero.FEMENINO,
						departamentoService.obtenerPorNombre("RRHH"),categoriaService.obtenerPorNombre("Jefe de Equipo")));
	empleadoService.agregar(
				new Empleado(0L, "juan", "juan@gmail.com", 1500d, true, Genero.MASCULINO,
						departamentoService.obtenerPorNombre("RRHH"),categoriaService.obtenerPorNombre("Administrativo")));
	empleadoService.agregar(
				new Empleado(0L, "maria", "maria@gmail.com", 2500d, true, Genero.FEMENINO,
						departamentoService.obtenerPorNombre("Informática"),  categoriaService.obtenerPorNombre("Programador Junior")));
	empleadoService.agregar(
